 ...
 // const { nodes, materials } = useGLTF("/gltf/shoe.gltf");
    return (
      <group ref={group} {...props} dispose={null}>
        ...
        <mesh geometry={nodes.cake_3.geometry}
          material={materials.Material03}    
          material-color="white"  material-emissive="orange"   
          scale={[0.3,0.1,0.3]} position={[0, -0.2, 0]}
        />
        <mesh geometry={nodes.cake_4.geometry}
         // material={materials.mesh}  // fuer shoe
         material={materials.Material04}   // fuer affe
     //  material ={nodes.Suzanne.material} // bei 1 Farbe korrekt 
          material-color="orange"  material-emissive="brown"  
         //  geometry ={nodes.Suzanne.geometry}
        scale={[0.3,0.1,0.3]}  position={[0,-0.2, 0]}
        />
          <mesh geometry={nodes.cake_5.geometry}
         // material={materials.mesh}  // fuer shoe
         material={materials.Material05}   // fuer affe
     //  material ={nodes.Suzanne.material} // bei 1 Farbe korrekt 
          material-color="brown"  material-emissive="brown"  
         //  geometry ={nodes.Suzanne.geometry}
        scale={[0.3,0.1,0.3]}  position={[0, -0.2, 0]}
        />
...
export default function App({ count = 15,  depth=60}) {
  ...
  return (
    ...
    <EffectComposer>
      ...
      target={[0,0,0]} focalLength={2.9} bokehScale={20} height={700} />
    </EffectComposer>
    </Suspense>
